#!/bin/bash
# API-based code reviewer — uses any OpenAI-compatible endpoint
...
#   AI_REVIEW_MODEL   — (optional) model override, defaults to gpt-4o

export API_BASE="${OPENAI_BASE_URL:-https://api.openai.com/v1}"
export API_KEY="${OPENAI_API_KEY}"
export MODEL="${AI_REVIEW_MODEL:-gpt-4o}"
